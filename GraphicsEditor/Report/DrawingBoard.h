 ...
 * supposed to contain the object of other classes like toolbar,
 colorpanel, menubar, and the drawing canvas on 
...
{	
	if(button==GLUT_LEFT_BUTTON && state==GLUT_DOWN)
	{
		...
		if(canvas_board->isClickInside(x,y))
		{
			...
			canvas_board->drawWithTool(drawingToolBar->getSelectedTool(),
				color_panel->getSelectedColor(), x, y);
		}
